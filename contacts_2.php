...
<head>
	<title>Contact &#8211; Travaux Divers</title>
						...
						<div class="content_wrap clearfix">
							<nav class="menu_main_nav_area menu_hover_fade">
								<ul id="menu_main" class="menu_main_nav">
									<li class="menu-item"><a href="index.html"><span>Accueil</span></a>
										<ul class="sub-menu">
											<li class="menu-item"><a href="index.html"><span>Accueil Default</span></a></li>
									...
									<li class="menu-item current-menu-item"><a href="contacts.php"><span>Contact</span></a></li>
								</ul>
							</nav>
...
<form id="sc_form_224916523_form" class="sc_input_hover_iconed contact_1" method="post" action="include/contact-form.php" >
<div class="sc_form_info">
	<div class="sc_form_item sc_form_field label_over"><input id="contact_form_username" type="text" name="name" aria-required="true"><label class="required" for="contact_form_username"><i class="sc_form_label_icon icon-user"></i><span class="sc_form_label_content" data-content="Nom">Nom</span></label></div>
...
<div class="sc_form_item contact_form_message"><textarea id="contact_form_message" name="message" aria-required="true"></textarea><label class="required" for="contact_form_message"><i class="sc_form_label_icon icon-feather"></i><span class="sc_form_label_content" data-content="Message">Message</span></label></div>
												...
												<div class="column-1_2 sc_column_item sc_column_item_1 odd first align-left">
													...
													<form id="mc4wp-form-1" class="mc4wp-form mc4wp-form-287" method="post" data-id="287" data-name="">
														<div class="mc4wp-form-fields">
															...
															<div class="hidden"><input type="text" name="_mc4wp_honeypot" value="" tabindex="-1" autocomplete="off" /></div><input type="hidden" name="_mc4wp_timestamp" value="1480072355" /><input type="hidden" name="_mc4wp_form_id" value="287" /><input type="hidden"
						...
						<div class="columns_wrap">
							<aside id="airsupply_widget_socials-2" class="widget_number_1 column-1_4 widget widget_socials">
								<div class="widget_inner">
									<div class="logo">
										<a href="index.html"><img src="images/logo_footer.png" class="logo_main" alt="" width="224" height="49"></a>
									</div>
									<div class="logo_descr"><!-- Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut.--><br /> 
										<br />
							...
							<aside id="nav_menu-2" class="widget_number_2 column-1_4 widget widget_nav_menu">
								...
								<div class="menu-widget-menu-container">
									<ul id="menu-widget-menu" class="menu">
										<li class="menu-item"><a href="#">Air Conditioning Repair</a></li>
										<li class="menu-item"><a href="#">Appliance Repair</a></li>
										<li class="menu-item"><a href="#">Electrical Service</a></li>
										<li class="menu-item"><a href="#">Heating Repair</a></li>
							...
							<aside id="nav_menu-3" class="widget_number_3 column-1_4 widget widget_nav_menu">
								...
								<div class="menu-widget-menu-2-container">
									<ul id="menu-widget-menu-2" class="menu">
										<li class="menu-item  current-menu-item "><a href="index.html">Contactez-nous</a></li>
										<li class="menu-item  "><a href="about-us-style-1.html">A propos de nous</a></li>
										<li class="menu-item  "><a href="all-posts.html">News &#038; Articles</a></li>
							...
							<aside id="text-2" class="widget_number_4 column-1_4 widget widget_text">
								<div class="textwidget">
									...
									<h5>06 61 96 42 80</h5>
									<p class="mail_footer">Contactez-Nous</p>
									<h5>202, Bd Abdelmoumene</h5>
									<h5>RDC N° 5 Casablanca</h5>
									<p class="address_footer">Localisation</p>
								</div>
							</aside>
						</div>
						<!-- /.columns_wrap -->
